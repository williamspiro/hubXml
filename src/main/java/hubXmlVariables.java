public class hubXmlVariables {

    // :)
    // VARIABLES TO SET
    // :)
    public static final String ROOT_URL = "https://www.awesomeblog.com";
    public static final String[] POSTS = {"http://www.ewebdy.com/2018/06/12/4tips-google-docs/"}; // "https://www.awesomeblog.com/awesome-post-1", "https://www.awesomeblog.com/awesome-post-2", "https://www.awesomeblog.com/awesome-post-3"
    ...
    public static final String POST_BODY_SELECTOR = ".mkdf-post-text-inner";
    // :)
    // END VARIABLES TO SET
    // :)
    // TODO FIGURE OUT HOW TO FIND POST URLS
    // TODO FIGURE OUT HOW TO FIND PUBLISH DATE
    // TODO FIGURE OUT FEATURED IMAGES
